  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <footer className="border-t border-neutral-200 dark:border-neutral-800 bg-[#FFFCF8]">
          <div className="flex flex-col md:flex-row mx-auto max-w-7xl px-6 py-12 md:items-start md:justify-between">
            <div className="mb-4 text-sm text-neutral-600 dark:text-neutral-400">
              <p>
                © {currentYear} {aboutMe.name}.
              </p>
              {aboutMe.secretDescription && (
                <p className="text-xs text-neutral-500 dark:text-neutral-500 mt-4 leading-relaxed max-w-md italic">
                  Representation is not merely instrumental—<br />
                  it shapes how the world is revealed.
                </p>
              )}
            </div>
